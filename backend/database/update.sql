...
('BTCUSD', 'Bitcoin / USD', 'Crypto', 43250.00, 2.5, '28.4B', 'twelvedata', 'BTC-USD', 'BTC/USD', 'COINBASE:BTCUSD', TRUE, 2, NULL, 1, 0.001, 0.001, 'coins', TRUE),
...
('ETHUSD', 'Ethereum / USD', 'Crypto', 2820.00, 1.8, '14.1B', 'twelvedata', 'ETH-USD', 'ETH/USD', 'COINBASE:ETHUSD', TRUE, 2, NULL, 1, 0.001, 0.001, 'coins', TRUE),
('XRPUSD', 'Ripple / USD', 'Crypto', 0.5612, 0.72, '1.1B', 'twelvedata', 'XRP-USD', 'XRP/USD', 'BITSTAMP:XRPUSD', TRUE, 4, NULL, 1, 0.001, 0.001, 'coins', TRUE),
...
('EURGBP', 'Euro / GBP', 'Forex', 0.8594, 0.08, '0.3T', 'twelvedata', 'EURGBP=X', 'EUR/GBP', 'FX:EURGBP', FALSE, 5, 0.00014, 100000, 0.01, 0.01, 'units', TRUE),
('EURJPY', 'Euro / JPY', 'Forex', 161.8400, 0.14, '0.5T', 'twelvedata', 'EURJPY=X', 'EUR/JPY', 'FX:EURJPY', FALSE, 3, 0.022, 100000, 0.01, 0.01, 'units', TRUE),
('GBPJPY', 'GBP / JPY', 'Forex', 187.3100, -0.09, '0.4T', 'twelvedata', 'GBPJPY=X', 'GBP/JPY', 'FX:GBPJPY', FALSE, 3, 0.028, 100000, 0.01, 0.01, 'units', TRUE),
('USDSGD', 'USD / SGD', 'Forex', 1.3487, 0.02, '0.2T', 'twelvedata', 'USDSGD=X', 'USD/SGD', 'FX:USDSGD', FALSE, 5, 0.00028, 100000, 0.01, 0.01, 'units', TRUE),
('USDTRY', 'USD / TRY', 'Forex', 32.4180, 0.21, '0.1T', 'twelvedata', 'USDTRY=X', 'USD/TRY', 'FX:USDTRY', FALSE, 3, 0.025, 100000, 0.01, 0.01, 'units', TRUE),
...
('AMZN', 'Amazon', 'Stocks', 182.3, 0.95, '3.6B', 'twelvedata', 'AMZN', 'AMZN', 'NASDAQ:AMZN', FALSE, 2, 0.04, 1, 0.01, 0.01, 'shares', TRUE),
('GOOGL', 'Alphabet Inc.', 'Stocks', 141.8, 0.6, '1.9B', 'twelvedata', 'GOOGL', 'GOOGL', 'NASDAQ:GOOGL', FALSE, 2, 0.02, 1, 0.01, 0.01, 'shares', TRUE),
('US500', 'US 500 CFD', 'Indices', 5235.4, 0.31, 'N/A', 'twelvedata', '^GSPC', 'SPX', 'OANDA:SPX500USD', FALSE, 2, 0.8, 10, 0.01, 0.01, 'index units', TRUE),
('NAS100', 'Nasdaq 100 CFD', 'Indices', 18244.7, 0.44, 'N/A', 'twelvedata', '^NDX', 'NDX', 'OANDA:NAS100USD', FALSE, 2, 1.2, 10, 0.01, 0.01, 'index units', TRUE),
('US30', 'US 30 CFD', 'Indices', 39280.5, 0.17, 'N/A', 'twelvedata', '^DJI', 'DJI', 'OANDA:US30USD', FALSE, 2, 3, 10, 0.01, 0.01, 'index units', TRUE),
('UK100', 'UK 100 CFD', 'Indices', 8162.4, -0.11, 'N/A', 'twelvedata', '^FTSE', 'UKX', 'OANDA:UK100GBP', FALSE, 2, 1.5, 10, 0.01, 0.01, 'index units', TRUE),
('DE40', 'Germany 40 CFD', 'Indices', 18115.3, 0.22, 'N/A', 'twelvedata', '^GDAXI', 'DAX', 'XETR:DAX', FALSE, 2, 1.8, 10, 0.01, 0.01, 'index units', TRUE),
('JP225', 'Japan 225 CFD', 'Indices', 38246.0, 0.27, 'N/A', 'twelvedata', '^N225', 'N225', 'TVC:NI225', FALSE, 2, 8, 10, 0.01, 0.01, 'index units', TRUE),
...
('WTI', 'WTI Crude Oil', 'Commodities', 78.42, -0.53, '10.8B', 'twelvedata', 'CL=F', 'CL1!', 'TVC:USOIL', FALSE, 3, 0.04, 1000, 0.01, 0.01, 'bbl', TRUE),
('BRENT', 'Brent Oil', 'Commodities', 82.4, -0.6, '12.1B', 'twelvedata', 'BZ=F', 'BRN1!', 'TVC:UKOIL', FALSE, 3, 0.08, 1000, 0.01, 0.01, 'bbl', TRUE),
