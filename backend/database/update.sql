...
('XAUUSD', 'Gold', 'Commodities', 2340.5, 0.85, '42.1B', 'yahoo', 'GC=F', 'OANDA:XAUUSD', FALSE, 3, 0.1, 100, 0.01, 0.01, 'units', TRUE),
('XAGUSD', 'Silver', 'Commodities', 28.45, 1.2, '8.4B', 'yahoo', 'SI=F', 'OANDA:XAGUSD', FALSE, 3, 0.05, 100, 0.01, 0.01, 'units', TRUE),
