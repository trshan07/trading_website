    ...
    <div className="mb-8 overflow-hidden relative animate-in fade-in slide-in-from-bottom-8 duration-500">
      <div className="flex space-x-3 overflow-x-auto pb-4 scrollbar-hide items-center">
        ...
        {[
          ...
          { id: 'commodities', label: 'Commodities', icon: 'ðŸ›¢ï¸' },
          { id: 'crypto', label: 'Crypto', icon: 'â‚¿' },
          { id: 'shares', label: 'Shares', icon: 'ðŸ“ˆ' },
          { id: 'indices-cash-1', label: 'Indices Cash 1', icon: 'ðŸ“Š' },
          { id: 'future-rolling-cfds', label: 'Future Rolling CFDs', icon: 'ðŸ“œ' },
          { id: 'brazilian-index', label: 'Brazilian Index', icon: 'ðŸ‡§ðŸ‡·' }
        ].map(cat => (
          <button
            key={cat.id}
